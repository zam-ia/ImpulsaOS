...
export function readableStatus(status: string): string {
  const map: Record<string, string> = {
    draft: "Borrador",
    idea_generated: "Idea generada",
    idea_approved: "Idea aprobada",
    script_generated: "Guion generado",
    copy_generated: "Copy generado",
    design_generated: "Diseno generado",
    needs_review: "Requiere revisión",
    approved: "Aprobado",
    pending_recording: "Pendiente de grabacion",
    pending_file: "Pendiente de archivo",
